...
| ✏️ **규정 개정** | 전체 개정 또는 조 단위 개정. 파일 업로드 시 AI가 개정안 자동 추출 |
...
2. **✏️ 규정 개정**:
   - 전체 개정: 새 본문 입력/업로드 → 옛 버전 자동 백업 → 신 버전 등록
   - 조 단위 개정: 파일 업로드 시 Claude가 개정안 자동 추출
